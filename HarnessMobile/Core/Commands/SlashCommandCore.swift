...
enum SlashCommandBuiltins {
    static let definitions: [SlashCommandDefinition] = [
        ...
        make(name: "new", description: "Create a new session", hint: "[title]") { invocation in
        ...
        make(name: "clear", description: "Clear the current session messages") { invocation in
        ...
        make(
            name: "feedback",
            description: "Rate the latest reply or add a note",
            ...
            case "dislike", "negative", "down", "Downvote", "👎":
                guard tail.isEmpty else {
                    throw SlashCommandArgumentError.invalidArguments(
                        command: "feedback",
        ...
        make(name: "compact", description: "Compact earlier session history") { invocation in
